...
export default function CatalogPage({ query }: CatalogPageProps) {
  ...
  const handleViewDetail = useCallback((productId: number) => {
  ...
  return (
    <>
      ...
      {!isLoading && !isError && filteredProducts.length > 0 && (
        <ProductList products={filteredProducts} onViewDetail={handleViewDetail} />
      )}
