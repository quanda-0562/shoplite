    ...
    <article className="group flex min-w-0 flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition duration-200 hover:-translate-y-1 hover:shadow-lg">
      ...
      <div className="flex flex-1 flex-col p-3 sm:p-4">
        ...
        <div className="mt-4 grid gap-2">
          <button type="button" onClick={() => onAddToCart(product)} className="rounded-xl bg-blue-600 px-3 py-2 text-sm font-bold text-white transition hover:bg-blue-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">Thêm vào giỏ</button>
